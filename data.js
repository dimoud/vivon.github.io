...
const FOODS_DB = [
  ...
  { id: "f13", name: "Σουβλάκι κοτόπουλο",        nameI18n: { el: "Σουβλάκι κοτόπουλο",      en: "Chicken Souvlaki",          es: "Souvlaki de pollo",        fr: "Souvlaki de poulet" },       unit: "g",  per100: { kcal: 165, p: 30, c: 0,  f: 4   }, category: "protein" },
  { id: "f14", name: "Κοτόπουλο τηγανιά",         nameI18n: { el: "Κοτόπουλο τηγανιά",       en: "Pan-fried Chicken",         es: "Pollo a la sartén",        fr: "Poulet poêlé" },             unit: "g",  per100: { kcal: 220, p: 28, c: 2,  f: 11  }, category: "protein" },
  { id: "f15", name: "Μπιφτέκι κοτόπουλο",        nameI18n: { el: "Μπιφτέκι κοτόπουλο",      en: "Chicken Burger Patty",      es: "Hamburguesa de pollo",     fr: "Steak haché de poulet" },    unit: "g",  per100: { kcal: 180, p: 24, c: 3,  f: 8   }, category: "protein" },
  { id: "f16", name: "Χοιρινά μπριζολάκια",       nameI18n: { el: "Χοιρινά μπριζολάκια",     en: "Pork Chops",                es: "Chuletas de cerdo",        fr: "Côtelettes de porc" },       unit: "g",  per100: { kcal: 250, p: 26, c: 0,  f: 16  }, category: "protein" },
  { id: "f17", name: "Χοιρινή τηγανιά",           nameI18n: { el: "Χοιρινή τηγανιά",         en: "Pan-fried Pork",            es: "Cerdo a la sartén",        fr: "Porc poêlé" },               unit: "g",  per100: { kcal: 280, p: 24, c: 2,  f: 20  }, category: "protein" },
  { id: "f18", name: "Μπιφτέκι ανάμεικτο",        nameI18n: { el: "Μπιφτέκι ανάμεικτο",      en: "Mixed Meat Patty",          es: "Hamburguesa mixta",        fr: "Steak haché mixte" },        unit: "g",  per100: { kcal: 230, p: 22, c: 4,  f: 15  }, category: "protein" },
  { id: "f19", name: "Φιλέτο μοσχαρίσιο",         nameI18n: { el: "Φιλέτο μοσχαρίσιο",       en: "Beef Fillet",               es: "Solomillo de ternera",     fr: "Filet de bœuf" },            unit: "g",  per100: { kcal: 180, p: 27, c: 0,  f: 8   }, category: "protein" },
  { id: "f20", name: "Μπιφτέκι μοσχαρίσιο",       nameI18n: { el: "Μπιφτέκι μοσχαρίσιο",     en: "Beef Burger Patty",         es: "Hamburguesa de ternera",   fr: "Steak haché de bœuf" },      unit: "g",  per100: { kcal: 210, p: 25, c: 3,  f: 12  }, category: "protein" },
  { id: "f21", name: "Συκώτι μοσχαρίσιο",         nameI18n: { el: "Συκώτι μοσχαρίσιο",       en: "Beef Liver",                es: "Hígado de ternera",        fr: "Foie de bœuf" },             unit: "g",  per100: { kcal: 180, p: 26, c: 4,  f: 6   }, category: "protein" },
  // ΥΔΑΤΑΝΘΡΑΚΕΣ
  ...
  { id: "c12", name: "Ρύζι ανάμεικτο",            nameI18n: { el: "Ρύζι ανάμεικτο",          en: "Mixed Rice",                es: "Arroz mixto",              fr: "Riz mélangé" },              unit: "g",  per100: { kcal: 150, p: 3,  c: 30, f: 2   }, category: "carbs" },
  { id: "c13", name: "Πατάτα πουρές",             nameI18n: { el: "Πατάτα πουρές",           en: "Mashed Potato",             es: "Puré de patata",           fr: "Purée de pomme de terre" },  unit: "g",  per100: { kcal: 110, p: 2,  c: 17, f: 4   }, category: "carbs" },
  { id: "c14", name: "Πατάτα φούρνου",            nameI18n: { el: "Πατάτα φούρνου",          en: "Roasted Potato",            es: "Patata al horno",          fr: "Pomme de terre rôtie" },     unit: "g",  per100: { kcal: 132, p: 2,  c: 22, f: 4   }, category: "carbs" },
  { id: "c15", name: "Πατάτα Air Fryer",          nameI18n: { el: "Πατάτα Air Fryer",        en: "Air Fryer Potato",          es: "Patata en freidora de aire",fr: "Pomme de terre à l'air fryer" }, unit: "g", per100: { kcal: 140, p: 2, c: 24, f: 4   }, category: "carbs" },
  { id: "c16", name: "Καλαμπόκι",                 nameI18n: { el: "Καλαμπόκι",               en: "Corn",                      es: "Maíz",                     fr: "Maïs" },                     unit: "g",  per100: { kcal: 100, p: 3.2,c: 21, f: 1.5 }, category: "carbs" },
  { id: "c17", name: "Μελιτζάνες ψητές",          nameI18n: { el: "Μελιτζάνες ψητές",        en: "Grilled Aubergine",         es: "Berenjena a la plancha",   fr: "Aubergine grillée" },        unit: "g",  per100: { kcal: 60,  p: 1,  c: 9,  f: 2.5 }, category: "carbs" },
  { id: "c18", name: "Λαχανικά ψητά",             nameI18n: { el: "Λαχανικά ψητά",           en: "Grilled Vegetables",        es: "Verduras a la plancha",    fr: "Légumes grillés" },          unit: "g",  per100: { kcal: 60,  p: 1.5,c: 8,  f: 2.5 }, category: "carbs" },
  // ΛΑΧΑΝΙΚΑ
  ...
  // ΣΑΛΑΤΕΣ (έτοιμα μείγματα, ξεχωριστά από τα μεμονωμένα λαχανικά)
  { id: "sl1", name: "Πράσινη σαλάτα",             nameI18n: { el: "Πράσινη σαλάτα",          en: "Green Salad",               es: "Ensalada verde",           fr: "Salade verte" },             unit: "g",  per100: { kcal: 25,  p: 1.2,c: 4,  f: 0.3 }, category: "salad" },
  { id: "sl2", name: "Σαλάτα ντομάτα",             nameI18n: { el: "Σαλάτα ντομάτα",          en: "Tomato Salad",              es: "Ensalada de tomate",       fr: "Salade de tomates" },        unit: "g",  per100: { kcal: 25,  p: 1,  c: 5,  f: 0.2 }, category: "salad" },
  { id: "sl3", name: "Σαλάτα λάχανο",              nameI18n: { el: "Σαλάτα λάχανο",           en: "Cabbage Salad",             es: "Ensalada de col",          fr: "Salade de chou" },           unit: "g",  per100: { kcal: 30,  p: 1.3,c: 6,  f: 0.2 }, category: "salad" },
  { id: "sl4", name: "Σαλάτα καρότο",              nameI18n: { el: "Σαλάτα καρότο",           en: "Carrot Salad",              es: "Ensalada de zanahoria",    fr: "Salade de carottes" },       unit: "g",  per100: { kcal: 40,  p: 1,  c: 9,  f: 0.2 }, category: "salad" },
  { id: "sl5", name: "Σαλάτα σπανάκι",             nameI18n: { el: "Σαλάτα σπανάκι",          en: "Spinach Salad",             es: "Ensalada de espinacas",    fr: "Salade d'épinards" },        unit: "g",  per100: { kcal: 25,  p: 2.5,c: 3.5,f: 0.3 }, category: "salad" },
  { id: "sl6", name: "Ανάμεικτη σαλάτα",           nameI18n: { el: "Ανάμεικτη σαλάτα",        en: "Mixed Salad",               es: "Ensalada mixta",           fr: "Salade mixte" },             unit: "g",  per100: { kcal: 30,  p: 1.3,c: 5.5,f: 0.3 }, category: "salad" },
  // ΛΙΠΑΡΑ
  ...
  { id: "l6",  name: "Ελαιόλαδο (ml)",            nameI18n: { el: "Ελαιόλαδο (ml)",          en: "Olive Oil (ml)",            es: "Aceite de oliva (ml)",     fr: "Huile d'olive (ml)" },       unit: "ml", per100: { kcal: 884, p: 0, c: 0, f: 100 }, category: "fat" },
  // ΓΑΛΑΚΤΟΚΟΜΙΚΑ
